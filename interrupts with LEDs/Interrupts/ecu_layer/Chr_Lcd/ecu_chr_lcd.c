...
static STD_ReturnType lcd_4bit_set_cursor(const chr_lcd_8bit_t *lcd,uint8 row,uint8 coulmn){
    ...
    coulmn--;
    switch(row){
        case ROW1 : ret = lcd_4bit_send_command(lcd,(0x80+coulmn));
        case ROW2 : ret = lcd_4bit_send_command(lcd,(0xC0+coulmn));
        case ROW3 : ret = lcd_4bit_send_command(lcd,(0x94+coulmn));
        case ROW4 : ret = lcd_4bit_send_command(lcd,(0xd4+coulmn));        
    }
    return ret;
}
static STD_ReturnType lcd_8bit_set_cursor(const chr_lcd_8bit_t *lcd,uint8 row,uint8 coulmn){
    ...
    coulmn--;
    switch(row){
        case ROW1 : ret = lcd_8bit_send_command(lcd,(0x80+coulmn));
        case ROW2 : ret = lcd_8bit_send_command(lcd,(0xC0+coulmn));
        case ROW3 : ret = lcd_8bit_send_command(lcd,(0x94+coulmn));
        case ROW4 : ret = lcd_8bit_send_command(lcd,(0xd4+coulmn));        
    }
    return ret;
}